...
func NextComponentHandler(snipeService *usecase.SnipeService) interaction.HandleFunc {
	c := &nextComponent{
...
func (c *nextComponent) execute(s *discordgo.Session, i *discordgo.InteractionCreate) (*discordgo.InteractionResponse, error) {
